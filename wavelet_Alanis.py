...
lmin_fit = # minimum should be the resolution, or a few times the resolution
lmax_fit = # maximum should be the radius of the image, approximately
...
with fits.open() as hdul:
    ...
    # we now want the actual data in the fits file
    data =
    ...
    # This is a lot of technical details you don't need to know, so don't stress about this.
    for scale in scales:
            # Create Mexican hat (Ricker) wavelet filter
    ...
    # Fitting the points you just plotted will return a power law index (since this is in log-space).
    # The power law index is the fractal dimension of the structures!
    ...
    # The dpi=200 keyword makes sure that it saves as a high-resolution image.
